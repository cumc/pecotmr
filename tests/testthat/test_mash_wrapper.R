test_that("merge_susie_cs merges credible sets correctly", {
  ...
  susie_fit_3 <- list(list())
  
  expected_output_3 <- data.frame(
  ...
  expected_output_7 <- data.frame(
    ...
    credible_set_names = c("cs_1_1", "cs_1_1,cs_2_2", "cs_1_2,cs_2_2", "cs_2_1,cs_3_3", "cs_3_2"),
  ...
  expected_output_9 <- data.frame(
    variant_id = c("variant1", "variant2", "variant3", "variant4", "variant5"),
    credible_set_names = c("cs_1_1", "cs_1_1", "cs_1_2", "cs_1_3", "cs_1_2"),
    max_pip = c(0.8, 0.6, 0.7, 0.9, 0.85),
    median_pip = c(0.8, 0.6, 0.7, 0.9, 0.85),
    stringsAsFactors = FALSE
  )
  ...
  expected_output_10 <- data.frame(
    variant_id = c("variant1", "variant2", "variant3", "variant4", "variant5", "variant6"),
    credible_set_names = c("cs_1_1", "cs_1_2,cs_2_2", "cs_1_1,cs_3_3", "cs_2_1", "cs_2_3,cs_3_2", "cs_3_1"),
    max_pip = c(0.8, 0.75, 0.7, 0.9, 0.85, 0.7),

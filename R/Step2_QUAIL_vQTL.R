...
#' Parse SNP name from chr:pos:ref:alt format
#' @param snp character string in format "chr1:100:A:T"
#' @return list with chr (numeric), pos (numeric), ref (character), alt (character)
#' @examples
#' parse_snp_info("chr1:100:A:T")

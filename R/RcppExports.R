...
dentist_iterative_impute <- function(LDmat, nSample, zScore, pValueThreshold, propSVD, gcControl, nIter, gPvalueThreshold, ncpus, seed, correct_chen_et_al_bug = FALSE) {
    .Call('_pecotmr_dentist_iterative_impute', PACKAGE = 'pecotmr', LDmat, nSample, zScore, pValueThreshold, propSVD, gcControl, nIter, gPvalueThreshold, ncpus, seed, correct_chen_et_al_bug)
}
